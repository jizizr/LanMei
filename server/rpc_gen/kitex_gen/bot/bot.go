...
type Data struct {
	...
	Qq    *string `thrift:"qq,3,optional" frugal:"3,optional,string" json:"qq,omitempty"`
	...
	Audio *string `thrift:"audio,7,optional" frugal:"7,optional,string" json:"audio,omitempty"`
...
var Data_Qq_DEFAULT string

func (p *Data) GetQq() (v string) {
	if !p.IsSetQq() {
		return Data_Qq_DEFAULT
	}
	return *p.Qq
}

var Data_Name_DEFAULT string
...
var Data_Type_DEFAULT string

func (p *Data) GetType() (v string) {
	if !p.IsSetType() {
...
var Data_Url_DEFAULT string

func (p *Data) GetUrl() (v string) {
	if !p.IsSetUrl() {
		return Data_Url_DEFAULT
	}
	return *p.Url
}

var Data_Audio_DEFAULT string

func (p *Data) GetAudio() (v string) {
	if !p.IsSetAudio() {
		return Data_Audio_DEFAULT
	}
	return *p.Audio
}

var Data_Title_DEFAULT string

func (p *Data) GetTitle() (v string) {
	if !p.IsSetTitle() {
		return Data_Title_DEFAULT
	}
	return *p.Title
}
...
func (p *Data) SetQq(val *string) {
	p.Qq = val
}
func (p *Data) SetName(val *string) {
	p.Name = val
}
func (p *Data) SetType(val *string) {
	p.Type = val
}
func (p *Data) SetUrl(val *string) {
	p.Url = val
}
func (p *Data) SetAudio(val *string) {
	p.Audio = val
}
func (p *Data) SetTitle(val *string) {
	p.Title = val
}
...
func (p *Data) IsSetQq() bool {
	return p.Qq != nil
}

func (p *Data) IsSetName() bool {
	return p.Name != nil
}

func (p *Data) IsSetType() bool {
	return p.Type != nil
}

func (p *Data) IsSetUrl() bool {
	return p.Url != nil
}

func (p *Data) IsSetAudio() bool {
	return p.Audio != nil
}

func (p *Data) IsSetTitle() bool {
	return p.Title != nil
}
...
func (p *Data) ReadField7(iprot thrift.TProtocol) error {
...
func (p *Data) ReadField8(iprot thrift.TProtocol) error {
...
func (p *Data) writeField3(oprot thrift.TProtocol) (err error) {
	if p.IsSetQq() {
		...
		if err := oprot.WriteString(*p.Qq); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *Data) writeField7(oprot thrift.TProtocol) (err error) {
	if p.IsSetAudio() {
		if err = oprot.WriteFieldBegin("audio", thrift.STRING, 7); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteString(*p.Audio); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *Data) writeField8(oprot thrift.TProtocol) (err error) {
	if p.IsSetTitle() {
...
func (p *Data) DeepEqual(ano *Data) bool {
	...
	if !p.Field7DeepEqual(ano.Audio) {
		return false
	}
...
func (p *Data) Field3DeepEqual(src *string) bool {

	if p.Qq == src {
		return true
	} else if p.Qq == nil || src == nil {
		return false
	}
	if strings.Compare(*p.Qq, *src) != 0 {
		return false
	}
	return true
}
func (p *Data) Field4DeepEqual(src *string) bool {
...
func (p *Data) Field5DeepEqual(src *string) bool {
...
func (p *Data) Field6DeepEqual(src *string) bool {
...
func (p *Data) Field7DeepEqual(src *string) bool {

	if p.Audio == src {
		return true
	} else if p.Audio == nil || src == nil {
		return false
	}
	if strings.Compare(*p.Audio, *src) != 0 {
		return false
	}
	return true
}
func (p *Data) Field8DeepEqual(src *string) bool {
